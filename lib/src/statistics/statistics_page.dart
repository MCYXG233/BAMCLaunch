...
class _StatisticsPageState extends State<StatisticsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final bgColor = isLight ? BAColors.backgroundOf(context) : BAColors.backgroundOf(context);
    final textColor = isLight ? BAColors.textPrimaryOf(context) : BAColors.textPrimaryOf(context);
      ...
      children: [
        ...
        Expanded(
          child: StatisticsCard(
            ...
            subtitle: _selectedTimeRange == TimeRange.week ? '最�?�? : '最�?0�?,
