...
class BAColors {
  ...
  static const Gradient coverGradient = LinearGradient(
    ...
    colors: [Color(0x004A90D9), Color(0x804A90D9)],
  );
  ...
  static const Gradient glassGradient = LinearGradient(
    ...
    colors: [Color(0x804A90D9), Color(0x402B5F8A), Color(0x201E2747)],
  );
  ...
  static Gradient backgroundGradientOf(BuildContext context) {
    ...
    return _isLight(context) ? lightBackgroundGradient : darkBackgroundGradient;
  }
  ...
  static Color infoOf(BuildContext context) {
    if (_isMC()) {
      return _isLight(context) ? MCThemeColors.info : MCThemeColorsDark.info;
    }
    return info;
  }
