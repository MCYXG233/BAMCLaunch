...
class SettingsPalette {
  ...
  /// 主文字色
  static Color textPrimary(BuildContext context) => const Color(0xFF1A1A2E);

  /// 次文字色
  static Color textSecondary(BuildContext context) => const Color(0xFF5A5A72);

  /// 浅灰文字（描述用）
  static Color textHint(BuildContext context) => const Color(0xFF9696A8);

  /// 强调色（紫色，继承蔚蓝档案主题）
  static const accent = Color(0xFF5C7CFA);

  /// 强调色浅版背景（用于左侧选中指示、提示卡片）
  static Color accentBackground = const Color(0xFFEDEFFC);
